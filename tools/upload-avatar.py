#!/usr/bin/env python3
"""
Upload avatar to X profile using fresh Chromium browser
"""
...
async def main():
    print("=" * 60)
    print("X PROFILE SETUP (Fresh Chromium)")
    print("=" * 60)
    
    async with async_playwright() as p:
        # Launch fresh Chromium browser
        ...
        try:
            ...
            print("[2/5] Going to X.com - Please log in manually...")
            ...
            # Setup profile
            print("[3/5] Navigating to profile settings...")
            await page.goto("https://x.com/settings/profile")
            await page.wait_for_load_state("networkidle")
            await asyncio.sleep(2)
            
            print("[4/5] Updating profile fields...")
            # Name
